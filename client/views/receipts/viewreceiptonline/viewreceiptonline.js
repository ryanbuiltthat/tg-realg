Template.viewreceiptonline.onRendered(function() {
  this.subscribe('receipts', Router.current().params._id);
  this.subscribe('pledges');
  this.subscribe('guarantees');
});
Template.viewreceiptonline.helpers({
  receipt: function() {
    return Receipts.findOne(Router.current().params._id);
  },
  pullGuarantees: function(selectedGuaranteesString){
